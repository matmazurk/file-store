...
type ListFilesResponse struct {
	...
	Pathes []string `protobuf:"bytes,1,rep,name=pathes,proto3" json:"pathes,omitempty"`
}
...
func (x *ListFilesResponse) GetPathes() []string {
	if x != nil {
		return x.Pathes
	}
	return nil
...
type StoreFileMsg struct {
	...
	Md_5      []byte `protobuf:"bytes,3,opt,name=md_5,json=md5,proto3" json:"md_5,omitempty"`
}

func (x *StoreFileMsg) Reset() {
	*x = StoreFileMsg{}
	if protoimpl.UnsafeEnabled {
...
func (x *StoreFileMsg) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*StoreFileMsg) ProtoMessage() {}

func (x *StoreFileMsg) ProtoReflect() protoreflect.Message {
	mi := &file_proto_file_proto_msgTypes[2]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use StoreFileMsg.ProtoReflect.Descriptor instead.
func (*StoreFileMsg) Descriptor() ([]byte, []int) {
	return file_proto_file_proto_rawDescGZIP(), []int{2}
}

func (x *StoreFileMsg) GetPath() string {
	if x != nil {
		return x.Path
	}
	return ""
...
func (x *StoreFileMsg) GetChunkData() []byte {
	if x != nil {
		return x.ChunkData
	}
	return nil
...
func (x *StoreFileMsg) GetMd_5() []byte {
	if x != nil {
		return x.Md_5
	}
	return nil
...
var file_proto_file_proto_rawDesc = []byte{
	...
	0x74, 0x6f, 0x22, 0x26, 0x0a, 0x10, 0x4c, 0x69, 0x73, 0x74, 0x46, 0x69, 0x6c, 0x65, 0x73, 0x52,
	0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x12, 0x12, 0x0a, 0x04, 0x70, 0x61, 0x74, 0x68, 0x18, 0x01,
	0x20, 0x01, 0x28, 0x09, 0x52, 0x04, 0x70, 0x61, 0x74, 0x68, 0x22, 0x2b, 0x0a, 0x11, 0x4c, 0x69,
	0x73, 0x74, 0x46, 0x69, 0x6c, 0x65, 0x73, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x12,
	0x16, 0x0a, 0x06, 0x70, 0x61, 0x74, 0x68, 0x65, 0x73, 0x18, 0x01, 0x20, 0x03, 0x28, 0x09, 0x52,
	0x06, 0x70, 0x61, 0x74, 0x68, 0x65, 0x73, 0x22, 0x54, 0x0a, 0x0c, 0x53, 0x74, 0x6f, 0x72, 0x65,
	0x46, 0x69, 0x6c, 0x65, 0x4d, 0x73, 0x67, 0x12, 0x12, 0x0a, 0x04, 0x70, 0x61, 0x74, 0x68, 0x18,
	...
	0x09, 0x63, 0x68, 0x75, 0x6e, 0x6b, 0x44, 0x61, 0x74, 0x61, 0x12, 0x11, 0x0a, 0x04, 0x6d, 0x64,
	0x5f, 0x35, 0x18, 0x03, 0x20, 0x01, 0x28, 0x0c, 0x52, 0x03, 0x6d, 0x64, 0x35, 0x22, 0x13, 0x0a,
	0x11, 0x53, 0x74, 0x6f, 0x72, 0x65, 0x46, 0x69, 0x6c, 0x65, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e,
	0x73, 0x65, 0x32, 0x70, 0x0a, 0x04, 0x46, 0x69, 0x6c, 0x65, 0x12, 0x34, 0x0a, 0x09, 0x4c, 0x69,
	0x73, 0x74, 0x46, 0x69, 0x6c, 0x65, 0x73, 0x12, 0x11, 0x2e, 0x4c, 0x69, 0x73, 0x74, 0x46, 0x69,
	...
	0x12, 0x32, 0x0a, 0x09, 0x53, 0x74, 0x6f, 0x72, 0x65, 0x46, 0x69, 0x6c, 0x65, 0x12, 0x0d, 0x2e,
	0x53, 0x74, 0x6f, 0x72, 0x65, 0x46, 0x69, 0x6c, 0x65, 0x4d, 0x73, 0x67, 0x1a, 0x12, 0x2e, 0x53,
	...
	0x6f, 0x6d, 0x2f, 0x6d, 0x61, 0x74, 0x6d, 0x61, 0x7a, 0x75, 0x72, 0x6b, 0x2f, 0x66, 0x69, 0x6c,
	0x65, 0x2d, 0x73, 0x74, 0x6f, 0x72, 0x65, 0x2f, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x62, 0x06, 0x70,
...
var file_proto_file_proto_goTypes = []interface{}{
	...
	(*StoreFileMsg)(nil),      // 2: StoreFileMsg
	(*StoreFileResponse)(nil), // 3: StoreFileResponse
}
var file_proto_file_proto_depIdxs = []int32{
	0, // 0: File.ListFiles:input_type -> ListFilesRequest
	2, // 1: File.StoreFile:input_type -> StoreFileMsg
	1, // 2: File.ListFiles:output_type -> ListFilesResponse
	3, // 3: File.StoreFile:output_type -> StoreFileResponse
